...
from .._types import LRScheduler
...
from ..logging import ConsoleLogger, DummyLogger, logger_factory
...
class StaticMethods:
    ...
    def setup_training_environment(args: TrainerArgs, config: TrainerConfig, gpu: int | None) -> tuple[bool, int]:
        ...
        if config.use_tpu:
            try:
                from ..utils.tpu import is_tpu_available, setup_tpu_training_env  # pylint: disable=import-outside-toplevel
