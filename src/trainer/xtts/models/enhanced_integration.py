...
from .xtts.models.xtts import Xtts, XttsArgs

# Import enhanced components  
from .xtts.models.enhanced_xtts import EnhancedXtts, EnhancedXttsConfig
from .xtts.layers.encodec import create_encodec_for_xtts
from .xtts.layers.streaming import create_streaming_decoder
...
class EnhancedXTTSWrapper(nn.Module):
    ...
    def _init_enhanced_components(self):
        ...
        if config.enable_quality_monitoring:
            from .xtts.layers.streaming import create_quality_monitor
    ...
    def _streaming_generation(
        ...
        **kwargs
        ...
        from .xtts.layers.streaming import StreamingBuffer
...
def create_enhanced_wrapper(
    ...
    try:
        # Create base config
        from .xtts.models.xtts import XttsArgs
