...
Subclass and overload the functions in the [```TrainerModel()```](src/trainer/model.py)
...
To add a new logger, you must subclass [BaseDashboardLogger](src/trainer/logging/base_dash_logger.py) and overload its functions.
