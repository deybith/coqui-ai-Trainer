...
1. **Neural Codec Integration** (`trainer/xtts/layers/encodec/`)
...
2. **Streaming Architecture** (`trainer/xtts/layers/streaming/`)
...
3. **Enhanced Model Core** (`trainer/xtts/models/enhanced_xtts.py`)
...
5. **Integration Layer** (`trainer/xtts/models/enhanced_integration.py`)
...
```python
# Location: trainer/xtts/layers/attention/mamba.py
...
```python
# Location: trainer/xtts/layers/attention/flash_attention.py
...
```python
# Location: trainer/xtts/layers/attention/rope.py
...
```python
# Location: trainer/xtts/layers/moe/switch_transformer.py
...
```python
# Location: trainer/xtts/layers/moe/language_experts.py
...
```python
# Location: trainer/xtts/layers/prosody/prosody_encoder.py
...
```python
# Location: trainer/xtts/layers/prosody/style_disentanglement.py
...
```python
# Location: trainer/xtts/layers/discriminators/
...
```python
# Location: trainer/xtts/losses/perceptual.py
...
```python
# Location: trainer/xtts/optimization/
...
#### 5.2 Streaming API
```python
# Location: trainer/xtts/api/streaming_server.py
