...
- `trainer/xtts/enhanced_configs.py` - Enhanced configuration classes
- `trainer/xtts/train_model.py` - Updated with enhanced training function
- `trainer/xtts/gpt_trainer.py` - Enhanced to support new configurations
