...
1. **Phase2EnhancedGPT** (`trainer/xtts/layers/xtts/phase2_enhanced_gpt.py`):
   - Line 108: `number_text_tokens: int = 512`  *(was 256)*
   - Line 418: `number_text_tokens=512,`  *(was 256)*

2. **Original GPT** (`trainer/xtts/layers/xtts/gpt.py`):
...
1. `/trainer/xtts/layers/xtts/phase2_enhanced_gpt.py`
2. `/trainer/xtts/layers/xtts/gpt.py`
